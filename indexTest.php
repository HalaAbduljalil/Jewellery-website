...
if(isset($_POST['add3'])) {
    ...
    if (isset($_SESSION['cart'])) {
        $item_array_id = array_column($_SESSION['cart'], "barcode1");
        print_r($item_array_id);
        if (in_array($_POST['productid'], $item_array_id)) {
            echo "<script>alert('Product is already added in the cart..!')</script>";
            echo "<script>window.location = 'indexTest.php'</script>";
        } else {
...
<div class="home_black_version">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="home_contact">
                            ...
                            <div class="contact_box">
                                <p>username : <a href="loginPage.php">login now!</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-4">
                        <div class="logo">
                            <a href="index.html"><img src="imagesMarjan/marjanLOGO.png " width="350"height="220" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-7 col-6">
                        <div class="middel_right">
                            ...
                            <div class="cart_link">
                                ...
                                if (isset($_SESSION['cart'])){
                                    $count = count($_SESSION['cart']);
                                    echo " <span class=\"cart_quantity\">$count</span>";
                                }else{
                                    echo "<span class=\"cart_quantity\">0</span>";
                                }
                                ...
                                <div class="mini_cart">
                                    ...
                                    <div class="cart_item">
                                        <div class="cart_img">
                                            <a href="#"><img src="imagesMarjan/kelly-sikkema-UZFnEbvwkzE-unsplash.jpg" alt=""></a>
                                        </div>
                                        <div class="cart_info">
                                            <a href="#">Earings</a>
                    ...
                    <div class="col-12">
                        <div class="main_menu_inner">
                            <div class="logo_sticky">
                                <a href="#"><img src="imagesMarjan/marjanLOGO.png" alt="logo"></a>
                            </div>
    ...
    <div class="slider_area slider_black owl-carousel">
        <div class="single_slider" data-bgimg="images/slider/slide1.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
        ...
        <div class="single_slider" data-bgimg="images/banner/banner3.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content">
        ...
        <div class="single_slider" data-bgimg="images/banner/crown3.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="#"><img src="images/slider/ring1.jpg" alt="banner1"></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="#"><img src="images/banner/ring4.jpg" alt="banner2"></a>
                            <div class="banner_content">
                                <p>Bestselling Rings</p>
                                <h2>Blue gold rings</h2>
                                <span>Sale 10% </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="#"><img src="images/banner/banner4.jpg" alt="banner3"></a>
                            <div class="banner_content">
                                <p>Featured Rings</p>
            ...
            <div class="row">
                <div class="blog_wrapper blog_column3 owl-carousel">
                    <div class="col-lg-20">
                        <div class="single_blog">
                            <div class="blog_thumb">
                                <a href="#"><img src="images/product2/ring8.jpg" alt="blog 4"></a>
                            </div>
                    ...
                    <div class="col-lg-20">
                        <div class="single_blog">
                            <div class="blog_thumb">
                                <a href="#"><img src="images/product2/ring9.jpg" alt="blog 1"></a>
                            </div>
                            <div class="blog_content">
                    ...
                    <div class="col-lg-20">
                        <div class="single_blog">
                            <div class="blog_thumb">
                                <a href="#"><img src="images/product2/crown7.jpg" style="background-size: cover" alt="blog 2"></a>
                            </div>
                            <div class="blog_content">
                    ...
                    <div class="col-lg-20">
                        <div class="single_blog">
                            <div class="blog_thumb">
                                <a href="#"><img src="images/slider/slide3.jpg" alt="blog 3"></a>
                            </div>
                            <div class="blog_content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="imagesMarjan/hands2.jpg" style="background-size: cover ">
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="images/product2/e1.jpg" style="background-size: cover ">
                        <div class="instagram__text">
                            <i class="ion-social-instagram"></i>
                            <a href="#">@ marjan</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="imagesMarjan/hands1.jpg"style="background-size: cover ">
                        <div class="instagram__text">
                            <i class="ion-social-instagram"></i>
                            <a href="#">@ marjan</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="images/product2/rings.jpg"style="background-size: cover ">
                        <div class="instagram__text">
                            <i class="ion-social-instagram"></i>
                            <a href="#">@ marjan</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="imagesMarjan/hands3.jpg"style="background-size: cover ">
                        <div class="instagram__text">
                            <i class="ion-social-instagram"></i>
                            <a href="#">@ marjan</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-bgimg="images/banner/crown2.jpg"style="background-size: cover ">
                        <div class="instagram__text">
                            <i class="ion-social-instagram"></i>
                            <a href="#">@ marjan</a>
                        </div>
